<section class="mt-md-4 pt-md-2 mb-5 p-5">
    <div class="row">
        <a class="col-xl-3 col-md-6 mb-5" href="{{ route('admin.panel.users') }}">
            <div class="card card-cascade cascading-admin-card">
                <div class="admin-up">
                    <i class="fas fa-users blue-color mr-3 z-depth-2"></i>
                    <div class="data">
        ...
        <a class="col-xl-3 col-md-6 mb-5" href="{{ route('admin.panel.stores') }}">
            <div class="card card-cascade cascading-admin-card">
                <div class="admin-up">
                    <i class="fas fa-store blue-color mr-3 z-depth-2"></i>
                    <div class="data">
        ...
        <a class="col-xl-3 col-md-6 mb-5" href="#">
            <div class="card card-cascade cascading-admin-card">
                <div class="admin-up">
                    <i class="fas fa-user-tag blue-color mr-3 z-depth-2"></i>
                    <div class="data">
    ...
    <div class="row">
        <a class="col-xl-3 col-md-6 mb-5" href="{{ route('admin.panel.packages') }}">
            <div class="card card-cascade cascading-admin-card">
                <div class="admin-up">
                    <i class="fas fa-cubes blue-color mr-3 z-depth-2"></i>
                    <div class="data">
